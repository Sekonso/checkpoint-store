...
import { Article, ArticleTag } from "@/types/models";
import { PageProps } from "@inertiajs/core";

interface AdminArticleEditPageProps extends FlashProps, PageProps {
    article: Article;
    tags: ArticleTag[];
...
export default function AdminArticleEditPage() {
    const { flash, article, tags, tagOptions, statusOptions } =
        usePage<AdminArticleEditPageProps>().props;
